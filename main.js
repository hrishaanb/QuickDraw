...
console.log("You have to draw - " + Element_of_array);
document.getElementById("sketch").innerHTML = "Sketch to be drawn: " + Element_of_array;
document.getElementById("time").innerHTML = "Time left: " + timer_seconds;    
...
//    function check_sketch () {
    ...
    if (mouseIsPressed) {
        ...
        timer_seconds = Math.floor(timer_counter/70);
        time_left = 30-timer_seconds;
        document.getElementById("time").innerHTML = "Time left: " + time_left + " seconds";
        console.log(time_left);
        
        if (timer_counter > 2100) {
            timer_counter = 0;
